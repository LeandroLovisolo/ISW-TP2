...
\begin{usecasesteps}
  ...
  \ucstep{El sistema registra el retiro de las bicicletas con los ID ingresados.}
	 {\ucalt{Si alguno de los IDs ingresados es erróneo, muestra que es incorrecto y vuelve a 2).}}
...
{\underline{Aclaración de 4.1:}} Veamos cómo el sistema realiza la corrección con un ejemplo:
