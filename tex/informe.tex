...
\begin{usecasesteps}
  ...
  \ucstep{El sistema muestra que la operación se realizó correctamente e informar la última ubicación de la bicicleta.}
...
\begin{usecasesteps}
  ...
  \ucstep{El sistema muestra que el ingreso de la nueva estación fue correcto.}
         {\ucalt{Si existe una estación con el mismo nombre o la misma ubicación, mostrar cuál fue el ingreso erróneo y volver a 1).}}
  \ucstep{Fin caso de uso.}{}
\end{usecasesteps}
